package net.digitalpear.ditr.common.datagen.worldgen;
...
public class DDConfiguredFeatureProvider extends FabricDynamicRegistryProvider {
    public DDConfiguredFeatureProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
        super(output, registriesFuture);
    }

    @Override
    protected void configure(RegistryWrapper.WrapperLookup registries, Entries entries) {
        add(registries, entries, DDConfiguredFeatures.ORE_BEDROCK_DIAMOND);
